...
const { crearAlternativa, listarAlternativas, actualizarAlternativa, eliminarAlternativa, datosAlternativa, busquedaAlternativas } = require('../controllers/alternativaController');
...
router.get('/busqueda/:filtro', auth, busquedaAlternativas);
